// locomotive js for scroll smooth
// for this attach two imp link first css and second javascrip those which are not made by us 
const scroll = new LocomotiveScroll({
    el: document.querySelector('#home-main'),
    smooth: true
});
